...
`id: 'settings'` (label "การตั้งค่า") — หมวดอื่น ๆ (ระบบบุคลากร, การลาเรียนของนักเรียน,
รับสมัคร & ทะเบียนนักเรียน ฯลฯ) เหลือแค่ **item ทางลัด** (`shortcut: true` + `anchor: '<section>'`)
ที่พาไปหน้า `settings/index.html#<section>` แทนที่จะมีเมนูตั้งค่าเต็ม ๆ อยู่ในหมวดตัวเอง —
